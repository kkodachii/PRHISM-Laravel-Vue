...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <!-- Primary Meta Tags -->
        <title>PRHISM - RHU Paombong</title>
        <meta name="title" content="PRHISM - RHU Paombong" />
        <meta name="description" content="Inventory management for Rural Health Units, streamlining medical supply tracking and ensuring timely restocking for better healthcare delivery." />
        <meta name="csrf-token" content="{{ csrf_token() }}">


        <!-- Open Graph / Facebook -->
        <meta property="og:type" content="website" />
        <meta property="og:url" content="www.prhism.com" />
        <meta property="og:title" content="PRHISM - RHU Paombong" />
        <meta property="og:description" content="Inventory management for Rural Health Units, streamlining medical supply tracking and ensuring timely restocking for better healthcare delivery." />
        <meta property="og:image" content="https://i.ibb.co/FDhvRGN/banner.png" />

        <!-- Twitter -->
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="www.prhism.com" />
        <meta property="twitter:title" content="PRHISM - RHU Paombong" />
        <meta property="twitter:description" content="Inventory management for Rural Health Units, streamlining medical supply tracking and ensuring timely restocking for better healthcare delivery." />
        <meta property="twitter:image" content="https://i.ibb.co/FDhvRGN/banner.png" />

        <meta name="keywords" content=" Inventory management, Medical supplies, Rural Health Unit">
        ...
        <title inertia>{{ config('app.name', 'PRHISM') }}</title>
