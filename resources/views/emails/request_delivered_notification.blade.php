...
<head>
    ...
    <title>Supply Request Delivered</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p class="greeting"><strong>Supply Request Delivered</strong></p>
            <p>We are happy to inform you that your supply request has been successfully delivered. The supplies have been confirmed and are now updated in your inventory.</p>
            
            <p>For further details regarding your delivery, please click the button below:</p>
