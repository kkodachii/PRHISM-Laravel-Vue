...
<body>
    <div class="email-container">
        <header>
            <img src="https://i.postimg.cc/CKNBJkWy/MUNICIPALITY-OF-PAOMBONG-4000-x-2000-px.png" alt="Paombong Logo">
        </header>

        <div class="content">
            <p class="greeting"><strong>Medicine Expiry Alert</strong></p>
            <p>The medicine <strong>{{ $generic_name }}</strong> is expiring soon on <strong>{{ $medicine->expiration_date }}</strong>.</p>
            <div class="btn-container">
                <a href="{{$url }}" class="btn">View Medicine</a>
            </div>
            <p>Please check your inventory to ensure proper stock rotation and management.</p>
