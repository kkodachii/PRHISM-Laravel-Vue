...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <p class="greeting"><strong>Delivery Return</strong></p>
            <p>We would like to inform you that a delivery return has been requested by <strong>{{ $barangay_name }}</strong>. The request for the return was made for the following reason: <strong>{{ $reason }}</strong>.</p>

            <p>To review the details of this delivery return and take the necessary actions, please click the button below:</p>
