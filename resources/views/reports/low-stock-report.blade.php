...
<head>
 ...
 <body>
    ...
    <h1 style="font-size: 25px; margin-bottom: 25px; text-align: center;">Low Stock Report <span style="font-weight: 400">{{$date}}</span></h1>
    <table class="borderless">
        <tr>
            <td class="borderless" style="text-align: left"><span style="font-weight:300">Generated by: </span>{{ $name ?? 'RHU Main' }}</td>
            <td class="borderless" style="text-align: left"><span style="font-weight:300">Threshold: </span>{{ $threshold }}</td>
        </tr>
        <tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $equip->batch->batch_number }}</td>
                <td>{{ \Carbon\Carbon::parse($equip->rawDateAcquired)->format('F j, Y') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $supply->med_sup_name }}</td>
                <td>{{ $supply->description }}</td>
                <td>{{ $supply->batch->batch_number }}</td>
                <td>{{ \Carbon\Carbon::parse($supply->rawDateAcquired)->format('F j, Y') }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
