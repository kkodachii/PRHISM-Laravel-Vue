...
onMounted(() => {
    ...
    const modal = new window.Modal(successModal);
    modal.show();
...
<div class="">
    <div class="relative p-4 w-full mt-10 max-w-md h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <p class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">Successfully approved request.</p>
            <Link :href="('/delivery')" @click="closeModal()" class="py-2 px-3 text-sm font-medium text-center text-white rounded-lg bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-900">
                Continue
            </Link>
        </div>
    </div>
