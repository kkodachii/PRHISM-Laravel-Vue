...
import MedicineRestore from "../../../js/Components/ItemRestore.vue";
...
watch(checked, (newVal) => {
    url.value = "/archived-medicine/export/" + newVal.join(",");
});
...
function getCategoryName(id) {
    const category = props.categoryNames.find((cat) => cat.id === id);
...
watch(
    search,
    debounce(
        (q) => router.get("/archived-medicine", { search: q }, { preserveState: true }),
        500
    )
);
...
function updateQuery() {
    ...
    router.get(
        "/archived-medicine",
        {
            ...
            onlyDeleted: onlyDeleted.value ? "true" : "false",
        },
        { preserveState: true }
    );
}
function toggleOnlyDeleted() {
    onlyDeleted.value = !onlyDeleted.value;
    updateQuery();
}
...
<template>
    ...
    <div
        id="generic-crud-modal"
        tabindex="-1"
        aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
    >
        <GenericNameForm :categories="categoryNames"></GenericNameForm>
    </div>

    <div
        id="medicine-crud-modal"
        tabindex="-1"
        aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
    >
    ...
    <div
        ...
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
    >
        <MedicineDelete :ID="selectedID" :item="'med'" />
    </div>
    ...
    <div
        ...
        class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
    >
        <MedicineRestore :ID="selectedID" :item="'med'" />
    </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    {{ medicine.category.category }}
                                        ...
                                        <td class="px-6 py-4">
                                            <StatusLabel :all="medicine.status === 'Expired' ? 'Expired, Archived' : 'Archived'" />
                                        </td>
                                    </tr>
                                    <tr
