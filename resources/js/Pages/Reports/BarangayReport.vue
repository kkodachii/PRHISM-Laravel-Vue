...
function generateReport() {
    Inertia.get(route('reports.barangay-inventory.generate'), {
        rhu_id: rhu_id.value,
        type: type.value,
...
<template>
    <Head title="Barangay Inventory Report" />
    <div
        ...
        <form @submit.prevent="generateReport">
            <div class="flex justify-between">
                <div>
                    <h1 class="text-xl md:text-3xl font-bold">
                        Generate Barangay Inventory Report
                    </h1>
                    <p class="text-md text-gray-700">List of inventory items per RHU and Barangay</p>
                </div>
                <button
                    type="submit"
            ...
            <div class="grid grid-cols-1 mt-5 p-3 gap-5 md:w-1/3">
                <div class="col-span-1">
                    <label class="block mb-2 font-medium text-md text-gray-800 dark:text-white" for="rhu_id">Select RHU:</label>
                    <select
                        v-model="rhu_id"
                        id="rhu_id"
                        required=""
                ...
                <div class="col-span-1">
                    <label class="block mb-2 font-medium text-md text-gray-800 dark:text-white" for="type">Select Type:</label>
                    <select v-model="type"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
