...
function generateReport() {
    Inertia.get(route('reports.most-requested.generate'), {
        type: type.value,
        limit: limit.value,
...
<template>
    <Head title="Most Requested Report" />
    <div
            ...
            <div class="flex justify-between">
                <div>
                    <h1 class="text-xl md:text-3xl font-bold">
                        Generate Most Requested Report
                    </h1>
                    <p class="text-md text-gray-700">Ranking of most requested items</p>
                </div>
                <button
                    type="submit"
