...
function generateReport() {
    Inertia.get(route('reports.medicine-expiring.generate'), {
        days: days.value,
...
<template>
    <Head title="Expiring Medicine Report" />
    <div
            ...
            <div class="flex justify-between">
                <div>
                    <h1 class="text-xl md:text-3xl font-bold">
                        Generate Expiring Medicine Report
                    </h1>
                    <p class="text-md text-gray-700">List of expiring medicines</p>
                </div>
                <button
                    type="submit"
