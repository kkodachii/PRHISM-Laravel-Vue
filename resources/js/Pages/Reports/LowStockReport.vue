...
const type = ref("medicine");
const dateRange= ref('');
const date_option = ref('All');

function generateReport() {
    Inertia.get(route("reports.low-stock.generate"), {
        ...
        <form @submit.prevent="generateReport">
            <div class="flex justify-between">
                <div>
                    ...
                    <p class="text-md text-gray-700">List of low stock items</p>
                </div>
                <button
                    type="submit"
            ...
            <div class="grid grid-cols-2 mt-5 p-3 gap-5 px-5">
