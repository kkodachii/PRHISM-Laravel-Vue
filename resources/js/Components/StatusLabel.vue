<template>
    <div>
        <div class="block md:hidden flex flex-col items-center whitespace-nowrap">
            <span
                v-for="(status, index) in computedStatuses"
                :key="index"
                :class="statusClasses[status]"
                class="text-xs font-medium mb-1 px-3 py-1 rounded-full"
            >
                {{ status }}
            </span>
        </div>
...
const statusClasses = {
    ...
    Deactivated: "bg-red-200 text-red-800 dark:bg-red-900 dark:text-red-300",
    Deactivate: "bg-gray-200 text-gray-800 dark:bg-gray-900 dark:text-gray-300",
    Condemned: "bg-gray-200 text-gray-800 dark:bg-gray-900 dark:text-gray-300", 
    Approved: "bg-purple-200 text-purple-800 dark:bg-purple-900 dark:text-purple-300", 
    Archived: "bg-red-200 text-red-800 dark:bg-red-900 dark:text-red-300",
