...
import { unshiftEquipment } from "../unshiftmodal";
import LoadingModal from "@/Components/LoadingModal.vue";

const props = defineProps({
    equipNames: {
        type: Array,
        default: () => [], // Default to an empty array if EquipNames is undefined
    },
    user: Object,
    batches: Array,
});
                ...
                <div class="grid gap-4 mb-4 grid-cols-3">
                    <div class="col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <p
                                v-if="form.errors.equipment_name"
                                class="text-red-600 text-sm"
                            >
                                {{ form.errors.equipment_name }}
                            </p>
                        </div>
                    </div>
